...
public class MenuAPI implements InventoryHolder {
    ...
    /**
     * Create a new MenuAPI with a custom size.
     *
     * @param size The size of the inventory.
     */
    public MenuAPI(int size) {
        this(size, InventoryType.CHEST.getDefaultTitle());
    }

    /**
     * Create a new MenuAPI with a custom size and title.
     *
     * @param size  The size of the inventory.
     * @param title The title (name) of the inventory.
     */
    public MenuAPI(int size, String title) {
        this(size, InventoryType.CHEST, title);
    }

    /**
     * Create a new MenuAPI with a custom type.
     *
     * @param type The type of the inventory.
     */
    public MenuAPI(InventoryType type) {
        this(type, type.getDefaultTitle());
    }

    /**
     * Create a new MenuAPI with a custom type and title.
     *
     * @param type  The type of the inventory.
     * @param title The title of the inventory.
     */
    public MenuAPI(InventoryType type, String title) {
        this(0, type, title);
    }

    private MenuAPI(int size, InventoryType type, String title) {
        ...
        if (inventory.getHolder() != this) {
            throw new IllegalStateException("Inventory holder is not MenuAPI, found: " + inventory.getHolder());
        }
    }

    public MenuAPI(Inventory inventory) {
